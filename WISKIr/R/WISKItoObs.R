#' Converts a WISKI time series to a \pkg{CRHMr} obs dataframe
#' @description Converts the WISKI date/time to a \pkg{CRHMr} datetime. If possible, it will also convert the variable name to a CRHM variable name. Note that this may be incorrect, as it is attempting to infer the variable from its units.
